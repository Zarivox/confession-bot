export default {
  ...
  joinModalTitle:    'Participation Confirmation',
  joinModalLabel:    'Type the exact phrase below to confirm',
  ...
  delaySuccess:  (h, type) => `✅ **${type === 'anonymous' ? 'Anonymous' : 'Public'}** cooldown updated: **${h}h**.`,
